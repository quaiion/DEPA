...
cpu.o: cpu.cpp
	$(COMPILER) $(GCC_FLAGS) -c cpu/cpu.cpp

cpu_func.o: cpu_func.cpp
	$(COMPILER) $(GCC_FLAGS) -c cpu/cpu_func.cpp

cpu_stack_func.o: cpu_stack_func.cpp
	$(COMPILER) $(GCC_FLAGS) -c cpu/cpu_stack_func.cpp


asm: asm.o asm_func.o common_func.o
	$(COMPILER) $(GCC_FLAGS) -o run_asm asm.o asm_func.o common_func.object

asm.o: asm.cpp
	$(COMPILER) $(GCC_FLAGS) -c asm/asm.cpp

asm_func.o: asm_func.cpp
	$(COMPILER) $(GCC_FLAGS) -c asm/asm_func.cpp


disasm: disasm.o disasm_func.o common_func.object
	$(COMPILER) $(GCC_FLAGS) -o disasm.o disasm_func.o common_func.object

disasm.o: disasm.cpp
	$(COMPILER) $(GCC_FLAGS) -c disasm/disasm.cpp

disasm_func.o: disasm_func.cpp
	$(COMPILER) $(GCC_FLAGS) -c disasm/disasm_func.cpp


common_func.o: common_func.cpp
	$(COMPILER) $(GCC_FLAGS) -c common/common_func.cpp
